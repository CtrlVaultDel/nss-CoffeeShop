    ...
    public class CoffeeRepository : ICoffeeRepository
    {
        ...
        public List<Coffee> GetAll()
        {
            using (var conn = Connection)
            {
                ...
                {
                    cmd.CommandText = "SELECT c.Id AS CoffeeId, c.Title, bv.Id As BeanVarietyId, bv.Name, bv.Region, bv.Notes FROM Coffee c JOIN BeanVariety bv ON c.BeanVarietyId = bv.Id";
